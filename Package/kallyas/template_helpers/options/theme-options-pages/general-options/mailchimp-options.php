...
$admin_options[] = zn_options_video_link_option( 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#4zt7-E985Xw', __( "Click here to access the video tutorial for this section's options.", 'zn_framework' ), array(
    'slug'        => 'mailchimp_options',
    'parent'      => 'general_options'
));
$admin_options[] = zn_options_doc_link_option( 'https://my.hogash.com/documentation/configure-mailchimp/', array(
    'slug'        => 'mailchimp_options',
    'parent'      => 'general_options'
));
