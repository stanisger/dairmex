...
class ZionTemplateSystem
{
	...
	function __construct()
	{
		...
		add_action( 'znpb_editor_tabs_content', array( $this, 'templatesTabContent' ) );
		add_action( 'znpb_editor_tabs_menu', array( $this, 'templatesTabMenu' ) );

		// SINGLE ELEMENT SAVING
		add_action( 'znpb_editor_tabs_content', array( $this, 'editorTabContent' ) );
		add_action( 'znpb_editor_tabs_menu', array( $this, 'editorTabMenu' ) );
	}
			...
			<div class="zn_pb_sidebar">
				...
				<div class="zn_pb_sidebar_more">
					...
					<div class="zn_pb_sidebar_more-panel zn_pb_animate">
						<a href="#" class="zn_pb_clear_page"><span class="dashicons dashicons-trash"></span> CLEAR PAGE
							ELEMENTS</a>
					</div>
				</div>
				...
				<div class="zn_pb_sidebar-inner zn-sidebar-scroll">
					<div class="zn_pb_sidebar-content">
						...
						<input type="text" placeholder="Template name"
							   class="znpb-template-name-input zn_pb_sidebar-content-input"/>
					</div>
				</div>
			...
			<div class="zn_pb_templates_container zn_pb_tab_content zn_has_isotope clearfix">
				...
				<div class="zn_pb_template_container">
					<div class="zn_pb_template zn_pb_uploadtpl">
						<label class="zn_pb_el_icon zn_pb_el_uploadicon js-znpb_upload_template" for="znpb_upload_input"
							   id="znpb_upload_input_label">
							<svg width="100px" height="100px" viewBox="0 0 100 100" version="1.1"
								...
								<path
									...
									fill="#757780"></path>
								<rect stroke="#979797" stroke-width="3" x="3" y="3" width="94" height="94"
									  rx="8"></rect>
							</svg>
							<span class="zn_pb_el_uploadicon-progress" id="zn_pb_el_uploadicon-progress"></span>
						</label>
						<input id="znpb_upload_input" class="znpb_upload_input" type="file"
				...
				$templates = $this->getPageBuilderTemplates();
				...
				if ( is_array( $templates ) ) {
					foreach ( $templates as $template ) {
						...
						echo $this->renderTemplate( $name[ 1 ] );
	...
	/**
	 *
	 *    HOOK INTO PAGE BUILDER TAB NAMES LIST
	 *
	 */
	...
	function editorTabContent()
	{
		...
		<div id="zn_pb_el_templates" class="zn_pb_el_templates zn_pb_tab zn_hide">
				...
				<div class="zn_pb_sidebar-inner zn-sidebar-scroll">
					...
					<div class="zn_pb_sidebar-content">
						...
						<div class="zn_pb_sidebar-content-desc">
							<p>Here you will find all your saved elements. If you want to add a saved element to your
								page, just dragg it into your desired location.</p>
						</div>
					</div>
			...
			<div class="zn_pb_saved_elements_container zn_pb_tab_content zn_has_isotope clearfix">
				...
				$templates = $this->getPageBuilderTemplates( 'zn_pb_el_templates' );
				...
				if ( is_array( $templates ) ) {
					foreach ( $templates as $template ) {
						...
						echo $this->getSavedElementMarkup( $name[ 1 ], $template_data );
	...
	function renderTemplate( $name )
	{
		...
		$template .= '<img class="zn_pb_el_icon" src="' . ZNB()->plugin_url . '/assets/img/default_icon.png' . '"/>';
	...
	function getSavedElementMarkup( $name, $template_data )
	{
		...
		$template_key = $this->generateKey( $name );
		$first_object = '';
		...
		$template = '<div class="zn_pb_template_container" data-template="' . $template_key . '" template data-issingle="true">';
		$template .= '<div class="zn_pb_element" data-template="' . $template_key . '" data-level="' . $template_data[ 'level' ] . '" data-object="' . $first_object . '" >';
		$template .= '<img class="zn_pb_el_icon" src="' . ZNB()->plugin_url . '/assets/img/default_icon.png' . '"/>';
		$template .= '<div class="zn_pb_el_title">' . $name . '</div>';
