					...
					while ( have_posts() ) {
						...
						if ( has_post_thumbnail( $post->ID ) ) {
							...
							if ( ! empty ( $thumb ) ) {
								...
								$image         = vt_resize( $thumb, null, $image_size['width'], $image_size['height'], true );
						...
						?>
						<div
							class="itemContainer zn_columns zn_columns<?php echo $data['blog_style_layout'];?> post-<?php the_ID(); ?> span<?php echo $columns_size;?>">
							<?php echo $image; ?>
							<div class="itemHeader">
								...
								<div class="post_details">
									...
									<span
										class="catItemAuthor"><?php echo __( 'by', THEMENAME );?> <?php the_author_posts_link(); ?></span>
								</div>
								<!-- end post details -->
							</div>
							<!-- end itemHeader -->
							...
							<div class="itemBody">
								...
								<div class="itemReadMore">
									<a class="readMore"
									   href="<?php the_permalink(); ?>"><?php echo __( 'Read more...', THEMENAME );?></a>
								</div>
								<!-- end read more -->
								<div class="clear"></div>
							</div>
