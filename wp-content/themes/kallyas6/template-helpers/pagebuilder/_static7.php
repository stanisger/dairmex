				...
				<div class="static-content event-style">
					<div class="row">
						...
						<div class="ud_counter">
							<ul id="Counter">
								<li><?php _e( '0', THEMENAME );?><span><?php _e( 'day', THEMENAME );?></span>
								</li>
								<li><?php _e( '00', THEMENAME );?><span><?php _e( 'hours', THEMENAME );?></span>
								</li>
								<li><?php _e( '00', THEMENAME );?><span><?php _e( 'min', THEMENAME );?></span>
								</li>
								<li><?php _e( '00', THEMENAME );?><span><?php _e( 'sec', THEMENAME );?></span>
								</li>
							</ul>
	...
	$zn_mailchimp = array ( 'zn_mailchimp' =>
		...
		jQuery('.nl-submit').click(function() {
			...
			jQuery.ajax({
				...
				error: function() {
					result_placeholder.html('". __('ERROR.', THEMENAME)."').css('color', 'red');
				}
			});
			return false;
		});
