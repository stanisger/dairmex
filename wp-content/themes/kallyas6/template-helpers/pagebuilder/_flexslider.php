...
{
	// LOAD CSS AND JS
	wp_enqueue_style( 'flex_slider', MASTER_THEME_DIR . '/sliders/flex_slider/css/flexslider.css' );
	...
	<div id="slideshow" class="notPadded <?php echo $style; ?>">
		...
		<div class="container zn_slideshow">
			...
			<div data-transition="<?php echo $options['fs_transition'];?>"
				 class="flexslider showOnMouseover zn_normal_flex <?php echo $thumbs; ?> drop-shadow <?php echo $options['fs_shadow'];?>">
				<ul class="slides">
					<?php
