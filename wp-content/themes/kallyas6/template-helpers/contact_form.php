<?php
	...
	function captcha( $field )
	{
		...
		if ( empty( $znData['rec_pub_key'] ) || empty( $znData['rec_priv_key'] ) ) {
		...
		<script type="text/javascript">
			var RecaptchaOptions = {
				theme: '<?php echo $znData['rec_theme']; ?>'
			};
		</script>
		<script type="text/javascript"
				src="http://www.google.com/recaptcha/api/challenge?k=<?php echo $znData['rec_pub_key']; ?>">
		</script>
		<noscript>
			<iframe src="http://www.google.com/recaptcha/api/noscript?k=<?php echo $znData['rec_pub_key']; ?>"
		...
		<div id="contact_form" class="rapid_contact ">
			...
			<form method="post" class="cf_validate form-horizontal zn_form">
				...
				<div class="control-group">
					<div class="controls">
						<input class=" btn " id="submit-form" type="submit" name="submit"
							   value="<?php echo $options['zn_cf_button_value']; ?>"/>
					</div>
				</div>
				<!-- end control group -->
			</form>
