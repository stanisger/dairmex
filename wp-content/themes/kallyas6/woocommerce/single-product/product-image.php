...
global $post, $woocommerce, $product, $znData;
...
<div class="images product-gallery ">
	...
	<div class="big_image">
		<a class="woocommerce-main-image zoom" itemprop="image"
		   href="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" rel="prettyPhoto[product-gallery]"
		   title="<?php echo get_the_title( get_post_thumbnail_id() ); ?>"><?php echo get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) ) ?></a>
	</div>
	<?php
...
<div class="product-gallery">
	...
	<div class="big_image">
		<img src="<?php echo wc_placeholder_img_src(); ?>" alt="<?php _e( 'Placeholder', THEMENAME ); ?>"/>
