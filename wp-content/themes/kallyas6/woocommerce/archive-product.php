		...
		<div id="mainbody">
			<div class="row">
				<?php
					...
					$sidebar_css = '';
					$has_sidebar = false;
					if($znData['woo_arch_sidebar_position']) {
						if ( $znData['woo_arch_sidebar_position'] == 'left_sidebar' ) {
							$content_css = 'span9 zn_float_right';
							$sidebar_css = 'sidebar-left';
							$has_sidebar = true;
						}
						elseif ( $znData['woo_arch_sidebar_position'] == 'right_sidebar' ) {
							$content_css = 'span9';
				...
				<div class="<?php echo $content_css; ?> zn_woo_cat_page">
					...
					<?php else : ?>
						...
						<?php if ( ! woocommerce_product_subcategories( array (
				...
				<?php if (isset($znData['woo_arch_sidebar_position']) && $znData['woo_arch_sidebar_position'] != 'no_sidebar' && ! empty($znData['woo_arch_sidebar'] ) ) { ?>
					<div class="span3">
						<div id="sidebar" class="sidebar <?php echo $sidebar_css; ?>">
							<?php if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar( $znData['woo_arch_sidebar'] ) ) : endif; ?>
						</div>
					</div>
				<?php } ?>
			</div>
