	...
	<div class="container">
		<div id="mainbody">
			<?php
				...
				if ( $znData['portfolio_style'] == 'portfolio_sortable' ) {
					?>
				...
				<?php }
				elseif ( $znData['portfolio_style'] == 'portfolio_carousel' ) {
					?>
					<div class="row">
						<div class="span12">
											...
											<div class="ptcontent">
												<h3 class="title">
													<a href="<?php the_permalink(); ?>"><span
															class="name"><?php the_title(); ?></span></a>
												</h3>
...
<?php
	if ( ! empty ( $post_meta_fields['port_media'] ) && is_array( $post_meta_fields['port_media'] ) ) {
		...
		foreach ( $post_meta_fields['port_media'] as $media )
		{
			...
			$portfolio_media = $media['port_media_video_comb'];
...
?>
				...
				elseif ( $znData['portfolio_style'] == 'portfolio_category' ) {

					if ( $znData['ports_num_columns'] == '1' ) {
						echo '<div class="span12">';
						...
						$proper_size = 12 / $znData['ports_num_columns'];
						$i           = 1;
						echo '<div class="span12">';
						echo '<div class="row zn_content_no_margin">';
						...
						while ( have_posts() ) {
							...
							if ( $i % $znData['ports_num_columns'] == 0 && $i % $znData['portfolio_per_page_show'] != 0 ) {
