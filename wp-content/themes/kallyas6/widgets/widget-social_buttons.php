...
class ZN_Widget_Social_Buttons extends WP_Widget
{
	...
	function __construct()
	{
		$widget_ops = array ( 'classname'   => 'widget_social_buttons',
							  'description' => __( 'This widget will display your desired social buttons.', THEMENAME )
		);
...
<?php
	...
	if ( ! empty ( $pinterest ) && ! empty ( $pin_image ) && ! empty ( $pin_desc ) ) {
		...
		echo '<a href="http://pinterest.com/pin/create/button/?url=' . $pin_url . '&amp;media=' . $pin_image . '&amp;description=' . $pin_desc . '" class="pin-it-button" count-layout="horizontal"><img src="http://assets.pinterest.com/images/PinExt.png" title="' . __( 'Pin It', THEMENAME ) . '" alt="' . __( 'Pin It', THEMENAME ) . '" /></a>';
...
<p><input id="<?php echo $this->get_field_id( 'facebook' ); ?>"
 ...
 for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php _e( 'Show Facebook Button ?', THEMENAME ); ?></label>
</p>
<p>
<i><?php _e( "In order for Facebook button to appear, you need to configure the Facebook options from inside the theme's option pannel", THEMENAME ); ?></i>
</p>
<p><input id="<?php echo $this->get_field_id( 'twitter' ); ?>"
 ...
 for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php _e( 'Show twitter Button ?', THEMENAME ); ?></label>
</p>
<p><input id="<?php echo $this->get_field_id( 'gplus' ); ?>"
 ...
 for="<?php echo $this->get_field_id( 'gplus' ); ?>"><?php _e( 'Show Google Plus Button ?', THEMENAME ); ?></label>
</p>
<p><input id="<?php echo $this->get_field_id( 'pinterest' ); ?>"
 ...
 for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php _e( 'Show pinterest Button ?', THEMENAME ); ?></label>
</p>

<p><label
 for="<?php echo $this->get_field_id( 'facebook_page' ); ?>"><?php _e( 'Facebook Username:', THEMENAME ); ?></label>
...
<p><label
 for="<?php echo $this->get_field_id( 'twitter_text' ); ?>"><?php _e( 'Twitter Text:', THEMENAME ); ?></label>
...
<p><label
 for="<?php echo $this->get_field_id( 'twitter_username' ); ?>"><?php _e( 'Twitter Username:', THEMENAME ); ?></label>
...
<p><label
 for="<?php echo $this->get_field_id( 'twitter_hastag' ); ?>"><?php _e( 'Twitter HashTag:', THEMENAME ); ?></label>
...
<p><label
 for="<?php echo $this->get_field_id( 'pin_image' ); ?>"><?php _e( 'Pinterest Image:', THEMENAME ); ?></label>
...
<p><label
 for="<?php echo $this->get_field_id( 'pin_desc' ); ?>"><?php _e( 'Pinterest Description:', THEMENAME ); ?></label>
