...
class ZN_Widget_Text extends WP_Widget
{
	...
	function __construct()
	{
		$widget_ops = array ( 'classname'   => 'widget_text_contact',
							  'description' => __( 'This widget will display your content with a "Say Hello" image on the top right.', THEMENAME )
		);
	...
	function form( $instance )
	{
		...
		<p><input id="<?php echo $this->get_field_id( 'filter' ); ?>"
				...
				for="<?php echo $this->get_field_id( 'filter' ); ?>"><?php _e( 'Automatically add paragraphs', THEMENAME ); ?></label>
		</p>
	<?php
	}
}
