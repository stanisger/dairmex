...
class ZN_Flickr_Widget extends WP_Widget
{
	...
	function form( $instance )
	{
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e( 'Flickr ID:', THEMENAME ) ?></label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'flickr_num' ); ?>"><?php _e( 'Number of images:', THEMENAME ) ?></label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'flickr_size' ); ?>"><?php _e( 'Image Size:', THEMENAME ); ?></label>
